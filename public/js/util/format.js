 ...
 * importable from Node and can be unit tested directly rather than through a source-extraction
 * harness (see PHASE4-PLAN.md §4). Anything that touches the document belongs in util/html.js.
 *
