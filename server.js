...
// ---------- the fix flow (Remediate / Fix / Verify) ----------
// The only path in this app that writes to a user's files. See lib/remediation.js for the
// full rationale: no claude call ever reaches disk, and checkCleanGitTarget() is what keeps
// every edit that does land inspectable and revertible outside this app.
const {
  checkCleanGitTarget,
